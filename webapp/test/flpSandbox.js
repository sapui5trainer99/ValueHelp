		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Value Help",
									"targetURL": "#valuehelpvaluehelp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"valuehelpvaluehelp-display": {
								"semanticObject": "valuehelpvaluehelp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=valuehelp.valuehelp",
									"url": sap.ui.require.toUrl("valuehelp/valuehelp")
								}
							}
						}
					}
